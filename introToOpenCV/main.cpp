...
int main()
{
    string image_path1("C:\\Users\\Luca\\Desktop\\Computer-Vision\\images_and_videos\\kyoto.jpg");
    string image_path2("C:\\Users\\Luca\\Desktop\\Computer-Vision\\images_and_videos\\kyoto.jpg");
    ...
    if (k == 's')
    {
        cv::imwrite("kyoto_night.png", astro2);
    }
    return 0;
}
